...
def parse_args():
    ...
    parser.add_argument('--csv-path',type=str,default="MDadd_log_ltn_max.csv")
...
Or = ltn.log.Wrapper_Connective(ltn.log.fuzzy_ops.Or_Max())
...
#@tf.function
def axioms(images_x1,images_x2,images_y1,images_y2,labels_z):
